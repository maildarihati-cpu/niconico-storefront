      ...
      <section className="w-full max-w-lg mx-auto px-6 py-10 md:py-16">
        ...
        <div className="flex flex-col items-center justify-center gap-4 border-t border-gray-200 pt-8">
          ...
          <div className="flex items-center gap-6 mt-2">
            {/* Facebook */}
            <Link href="https://www.facebook.com/NiconicoSwimwear/" className="hover:scale-110 transition-transform">
            ...
            {/* Instagram */}
            <Link href="https://www.instagram.com/niconicoswimwear/#" className="hover:scale-110 transition-transform">
            ...
            {/* TikTok */}
            <Link href="https://www.tiktok.com/@niconicoswimwearofficial" className="hover:scale-110 transition-transform">
              <svg width="36" height="36" viewBox="0 0 24 24" fill="#EF7044" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* YouTube */}
            <Link href="https://www.youtube.com/@niconicoswimwearofficial" className="hover:scale-110 transition-transform">
