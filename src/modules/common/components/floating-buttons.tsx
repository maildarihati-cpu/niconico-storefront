  ...
  return (
    <div className="fixed bottom-8 right-8 z-[999] flex flex-col gap-4 items-center">
      ...
      {!hideShopNow && (
        <LocalizedClientLink 
          href="/store"
          className="flex items-center justify-center w-14 h-14 bg-[#000000] rounded-full shadow-[0_8px_0px_rgb(0,0,0,0.15)] hover:bg-[#EF7044] hover:scale-110 transition-all duration-300"
        >
