...
export default function InstagramFeed() {
  return (
    /* 🌟 PERUBAHAN: Menambahkan mt-12 untuk margin top 48px */
    <section className="mt-12 pb-12 px-4 md:px-8 max-w-[1000px] lg:max-w-[1200px] mx-auto bg-white">
      ...
      <div className="lg:hidden">
        ...
        <div className="p-2 md:p-3 rounded-[2rem] md:rounded-[2.5rem] shadow-[0_0_20px_rgba(237,87,37,0.15)] bg-white mb-4">
          ...
          <div className="grid grid-cols-5 gap-2 md:gap-4 mb-2 md:mb-4">
            ...
            <div className="col-span-1 flex flex-col gap-2 md:gap-4">
              <a href="https://www.tiktok.com/@niconicoswimwearofficial" className="relative aspect-square rounded-lg md:rounded-xl overflow-hidden group block shadow-sm">
              ...
              <a href="https://www.youtube.com/@niconicoswimwearofficial" className="relative aspect-square rounded-lg md:rounded-xl overflow-hidden group block shadow-sm">
        ...
        <div className="flex flex-col items-end mt-4 pr-2 md:pr-4">
          ...
          <div className="flex items-center justify-end gap-3 md:gap-4">
            <a href="https://www.facebook.com/NiconicoSwimwear/" className="hover:scale-110 transition-transform">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="#1877F2">
                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.469h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.469h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
              </svg>
            </a>
            <a href="https://www.instagram.com/niconicoswimwear/" className="hover:scale-110 transition-transform">
      ...
      <div className="hidden lg:grid grid-cols-4 gap-4 w-full">
        ...
        <div className="flex flex-col gap-4">
          <a href="#" className="w-full aspect-[3/4] rounded-2xl overflow-hidden relative group shadow-sm">
            <img src="https://images.unsplash.com/photo-1515372039744-b8f02a3ae446?q=80&w=600&auto=format&fit=crop" alt="Desktop UGC 1" className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
          </a>
          <div className="flex flex-col gap-4 flex-1">
            <a href="#" className="w-full flex-1 rounded-2xl overflow-hidden relative group shadow-sm">
              <img src="https://images.unsplash.com/photo-1502716119720-b23a93e5fe1b?q=80&w=600&auto=format&fit=crop" alt="Desktop UGC 2" className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
            </a>
            <a href="https://www.tiktok.com/@niconicoswimwearofficial" className="w-full flex-1 rounded-2xl overflow-hidden relative group shadow-sm">
              <img src="https://images.unsplash.com/photo-1507525428034-b723cf961d3e?q=80&w=600&auto=format&fit=crop" alt="Desktop UGC 3" className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
            </a>
          </div>
        </div>
        ...
        {/* KOLOM 2 (Tengah Kiri) */}
        <div className="flex flex-col gap-4">
          <a href="https://www.youtube.com/@niconicoswimwearofficial" className="w-full aspect-[4/5] rounded-2xl overflow-hidden relative group shadow-sm">
            <img src="https://images.unsplash.com/photo-1499793983690-e29da59ef1c2?q=80&w=600&auto=format&fit=crop" alt="Desktop UGC 4" className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
          </a>
          <a href="#" className="w-full flex-1 rounded-2xl overflow-hidden relative group shadow-sm">
            <img src="https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?q=80&w=600&auto=format&fit=crop" alt="Desktop UGC 5" className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
          </a>
        </div>
        ...
        <div className="col-span-2 flex flex-col gap-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <a href="#" className="w-full aspect-[4/5] rounded-2xl overflow-hidden relative group shadow-sm">
              <img src="https://images.unsplash.com/photo-1520116468816-95b69f847357?q=80&w=600&auto=format&fit=crop" alt="Desktop UGC 6" className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
            </a>
            <a href="#" className="w-full aspect-[4/5] rounded-2xl overflow-hidden relative group shadow-sm">
              <img src="https://images.unsplash.com/photo-1602498456745-e9503b30470b?q=80&w=600&auto=format&fit=crop" alt="Desktop UGC 7" className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
            </a>
          </div>
          
          <a href="#" className="w-full flex-1 min-h-[220px] rounded-2xl overflow-hidden relative group shadow-sm">
