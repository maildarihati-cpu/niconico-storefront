    ...
    <footer className="relative bg-black text-white pt-16 flex flex-col items-center overflow-hidden">
      ...
      <div className="container mx-auto px-6 w-full max-w-[1300px] flex flex-col lg:flex-row lg:justify-between lg:items-center gap-8 lg:gap-12">
        ...
        <div className="flex lg:hidden items-center justify-center gap-8 mb-12 text-white/80 order-3 w-full">
          {/* Facebook */}
          <Link 
            href="https://www.facebook.com/NiconicoSwimwear/" 
            target="_blank" 
          ...
          {/* Instagram */}
          <Link 
            href="https://www.instagram.com/niconicoswimwear/" 
            target="_blank" 
            rel="noopener noreferrer" 
            className="hover:text-[#EF7044] transition-all hover:scale-110"
          >
          ...
          {/* TikTok */}
          <Link 
            href="https://www.tiktok.com/@niconicoswimwearofficial" 
            target="_blank" 
            rel="noopener noreferrer" 
            className="hover:text-[#EF7044] transition-all hover:scale-110"
          >
          ...
          {/* YouTube */}
          <Link 
            href="https://www.youtube.com/@niconicoswimwearofficial" 
            target="_blank" 
            rel="noopener noreferrer" 
            className="hover:text-[#EF7044] transition-all hover:scale-110"
          >
