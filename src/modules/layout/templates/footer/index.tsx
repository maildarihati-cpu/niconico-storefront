        ...
        <div className="w-full flex flex-row justify-between items-start mb-16 gap-4">
          ...
          <div className="w-2/3 flex justify-end gap-x-8 md:gap-x-16">
            <div className="flex flex-col gap-y-5 text-[13px] md:text-[15px] text-gray-200">
              ...
              <Link href="/make-your-own-brand" className="hover:text-[#DE7959] transition-colors leading-tight">Make Your <br className="hidden md:block" />Own Brand</Link>
              <Link href="/our-store" className="hover:text-[#DE7959] transition-colors">Stores</Link>
            </div>
            ...
            <div className="flex flex-col gap-y-5 text-[13px] md:text-[15px] text-gray-200">
              ...
              {/* Facebook */}
              <Link href="https://www.facebook.com/NiconicoSwimwear/" className="hover:text-[#DE7959] transition-all hover:scale-110">
              ...
              {/* Instagram */}
              <Link href="https://www.instagram.com/niconicoswimwear/" className="hover:text-[#DE7959] transition-all hover:scale-110">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* TikTok */}
              <Link href="https://www.tiktok.com/@niconicoswimwearofficial" className="hover:text-[#DE7959] transition-all hover:scale-110">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* YouTube */}
              <Link href="https://www.youtube.com/@niconicoswimwearofficial" className="hover:text-[#DE7959] transition-all hover:scale-110">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
